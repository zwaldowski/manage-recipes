...
struct FreshDownloadPDFs: AsyncParsableCommand {
    
    static let configuration = CommandConfiguration(
        commandName: "fresh-download-pdfs")
    ...
    func downloadRecipePDF(for recipe: HelloFresh.Recipe, using session: URLSession) async throws {
        guard let remoteURL = recipe.cardLink else { return }
